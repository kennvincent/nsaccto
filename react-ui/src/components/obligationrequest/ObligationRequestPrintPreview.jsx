...
export default function ObligationRequestPrintPreview() {
  ...
  return (
    ...
    <div >
       ...
       <div ref={componentRef} className='overflow-hidden  text-2xl'>
       
     
            <div className='text-center bg-white mt-16 text-3xl'>
            ...
            <div className='h-[1500px]'>
                ...
                <div className='flex border w-[1500px] m-auto'>
                    ...
                    <div className='w-[15%] h-12 border py-0 px-2'>
                        <p className='text-right text-4xl'> {Number(total).toLocaleString()}</p>
                    </div>
                </div>
                <div className='flex w-[1500px] m-auto'>
