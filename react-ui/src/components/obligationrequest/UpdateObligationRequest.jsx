...
const UpdateObligationRequest = () => {
    ...
    const handleBack = ()=>{
        navigate('/obredit',{state:{items,payee,particulars}});
    }
       ...
       <div ref={componentRef} className='overflow-hidden  text-xl w-[1200px] m-auto mb-8'>
            ...
            <div className='flex w-[1024px] m-auto  pb-4'>
                ...
                {showSave?<TiArrowBack  onClick={handleBack}className='absolute right-[19rem] top-20 text-3xl'  />:<IoMdCloseCircleOutline  onClick={handleClose}className='absolute right-[19rem] top-20 text-3xl'  />} */}
                    ...
                    {showSave?<button  onClick={handleUpdateOBR} className='btn btn-primary btn-sm mr-2' >Update</button>:<button  onClick={handlePrint} className='btn btn-primary btn-sm mr-2' >Print</button>}
...
export default UpdateObligationRequest
