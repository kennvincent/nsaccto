...
:''}</td>
                        ...
                        <td className='py-1 text-right'>{(Number(budget.augmentation) + (-1 * Number(budget.lessaugmentation))).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        {/* realignment */}
                        <td className='py-1 text-right'></td> 

                        {/* <td className='py-1 text-right'>{budget.proposedamount>0?Number(budget.proposedamount).toLocaleString():''}</td> */}
                        {/* total appropriation */}
                        <td className='py-1 text-right'>{((Number(budget.proposedamount)) + (Number(budget.augmentation) + (-1 * Number(budget.lessaugmentation)))).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })
                    }</td>
...
:''}</td> */}
                       ...
                       <td className='py-1 text-right'>{((Number(budget.proposedamount) + (Number(budget.augmentation) + (-1 * Number(budget.lessaugmentation)))) - Number(budget.totalobligated)).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
