...
export default function CreateVoucher() {
    ...
    const [provincialAccountant,setProvincialAccountant] = useState();
      ...
      <div className='font-serif w-[1024px] border border-black  m-auto bg-white'>
        ...
        <div className='border-t border-black flex h-14'>
          ...
          <div className='p-0 px-1 border-r border-black w-[630px]'>
            <p className='p-0 mt-2 '><input type="text" name="payee" id="payee" className='w-full' /></p>
          </div>
        ...
        <div className='border-t border-black flex h-14'>
          ...
          <div className='p-0 px-1 border-r border-black w-[630px]'>
            <p className='p-0 mt-2 '><p className='p-0 mt-2 '><input type="text" name="address" id="address" className='w-full' /></p></p>
          </div>
        ...
        <div className='border-t border-black flex h-[250px]'>
          <div className='p-0  border-r border-black w-[740px] font-sans '>
            <textarea name="explanation" id="" cols="30" rows="10" className='w-full border-0'></textarea>
          </div>
          ...
          <div className='flex w-[512px] h-7'>
            ...
            <div className='flex w-[300px] h-7 border-r border-black px-1'>
              ...
              <div className='w-[210px] h-7'>
                <input type="text" name="bankname" id="bankname"  className='w-[210px] h-7' />
              </div>
