...
import { DASHBOARD_ACCOUNTING_SIDEBAR_LINKS } from '../../lib/consts/navigation'
import { DASHBOARD_BUDGET_SIDEBAR_LINKS } from '../../lib/consts/navigation'
...
useEffect(()=>{
  ...
  if(usertype=='USR'){
    setMenu(DASHBOARD_SIDEBAR_LINKS);
  }if(usertype=='ACTG'){
    setMenu(DASHBOARD_ACCOUNTING_SIDEBAR_LINKS);
  }if(usertype=='BDGT'){
    setMenu(DASHBOARD_BUDGET_SIDEBAR_LINKS);
  }
